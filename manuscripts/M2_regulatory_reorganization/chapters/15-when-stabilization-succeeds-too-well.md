...
# When Stabilization Succeeds Too Well

Stabilization mechanisms are typically evaluated by their ability to suppress overt instability. When a system becomes quieter, less reactive, and more coherent, it is usually taken as evidence of regulatory success. This assumption holds in many contexts. It fails, however, in a narrow but clinically consequential class of cases where stability itself becomes the source of later collapse.
...
### Mythologized Object Selection Under PM-OCAC

Before examining how exclusivity destabilizes PM-OCAC dyads, it is necessary to clarify how mythologized objects are selected in the first place. Contrary to clinical assumptions that treat object choice as preference-driven or contingent, PM-OCAC imposes strict selection constraints. Mythologization cannot stabilize envy unless the object satisfies them.

First, the object must possess demonstrable superiority in at least one identity-defining domain of the structure. This domain is not aspirational or cosmetic; it is constitutive of self-recognition. If the structure values intellect, the object must exhibit intellectual legitimacy. If the structure values physical discipline, the object must embody it. PM-OCAC cannot mythologize what it cannot internally verify as legitimate within its own value architecture.
...
These constraints explain why PM-OCAC structures often fixate on highly specific individuals while ignoring superficially “higher-status” alternatives. Selection is structural, not opportunistic.

What unifies these constraints is not preference, admiration, or attachment style, but protection. PM-OCAC mythologization stabilizes only when the object’s superiority renders inferiority survivable under exposure. The object must not merely exceed the structure symbolically; it must be capable of buffering the specific forms of evaluation, competition, or threat that would otherwise render inferiority unsafe. Attributes such as intellect, physical dominance, social authority, or material resources only stabilize regulation insofar as they translate into credible protection within the structure’s threat environment.

### Protective Capacity and Inferiority Safety
...
### Mythologization Under Conditions of Guaranteed Access

Mythologization is not sustained by admiration alone. It depends on discretion: the sense that access to the object is permitted rather than owed, tolerated rather than guaranteed. Discretion preserves hierarchy by keeping inferiority voluntary.

Exclusive relationships erode discretion by design. When access is continuous, mythologized superiority becomes less legible. Authority diffuses. The object, no longer needing to manage distance, often relaxes into reciprocity. Decisions are shared. Vulnerabilities are exchanged. Mutual dependence increases.

From a conventional relational standpoint, these developments signal intimacy and health. From the standpoint of PM-OCAC regulation, they represent a progressive loss of inferiority shelter. The structure does not experience this as closeness. It experiences it as exposure.

Importantly, this exposure does not originate in object failure. It originates in relational success.

### Symmetry Drift as an Emergent Dyadic Process

The erosion of asymmetry in exclusive PM-OCAC dyads is not the result of manipulation, regression, or covert dominance seeking. It is an emergent process driven by the very traits that make these structures appear stable: emotional regulation, low demand, competence, and non-competitiveness.
...
This is why escalation often appears late, abrupt, and out of character. It is not the culmination of mounting distress. It is a corrective maneuver triggered by structural success.

### Acting Out as Asymmetry Restoration
...
### Engineering Superiority Without Conflict

Overt acting out is not the only asymmetry-restoration strategy available to PM-OCAC structures. More often, they attempt quieter corrections that preserve relational harmony.
...
Clinically, these dynamics are often misclassified as “quiet borderline.” The misclassification arises from surface similarities: delayed escalation, internalized tension, sudden conflict, and rapid stabilization afterward.
...
PM-OCAC exclusive relationships are not inherently unstable. They function when asymmetry remains fully active and legible within the dyad. This does not require cruelty, humiliation, or control. It requires that authority, responsibility, and emotional containment do not collapse into parity.

When asymmetry is intact, there is no need for correction. The structure remains regulated. Escalation latency becomes effectively infinite.

When asymmetry erodes, correction becomes inevitable.
...
This chapter does not argue for new diagnostic categories. It argues for recognizing a dyadic failure mode that emerges from successful stabilization under altered constraints. Misidentifying this process leads clinicians to intervene in ways that increase symmetry and worsen instability.

Understanding when stabilization has succeeded too well allows prediction without moralization and intervention without misattribution.
